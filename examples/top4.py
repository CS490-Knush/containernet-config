...
s2 = net.addSwitch('s2')
info('*** Creating links\n')
net.addLink(d1, s1, cls=TCLink, bw = 10, use_tbf = True)
net.addLink(s1, s2, cls=TCLink, bw = 5, use_tbf = True)
net.addLink(s2, d2, cls=TCLink, bw = 10, use_tbf = True)
net.addLink(s2, d3, cls=TCLink, bw = 10, use_tbf = True)
